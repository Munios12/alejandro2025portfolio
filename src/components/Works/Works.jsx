    ...
    <>
      <section className={styles.sectionWorks} id="works">
        ...
        <ul className={styles.works__projectList}>
          {worksList.map((e) => {
            return (
              <li key={e.id} className={styles.work1}>
                <div
                  className={styles.work1__card}
                  style={{ backgroundImage: `url(${e.img})` }}
                >
                  <a href={`${e.linkWebSite}`}></a>
                </div>
                <div className={styles.overlay}>
                  <h4>{e.titulo}</h4>
                  <p>{e.description}</p>
                  <div className={styles.work1__card__links}>
                    <a
                      className={styles.work1__card__applink}
                      href={`${e.linkGithub}`}
                    >
